...
function facebookOpen() {
  window.open("https://www.facebook.com/domenico.tenace/");
}
function twitterOpen() {
  window.open("https://twitter.com/dome_tena99");
}
function linkedinOpen() {
  window.open("https://www.linkedin.com/in/domenico-tenace-982ba51ab/");
}
function githubOpen() {
  window.open("https://github.com/DomeT99");
}
class SocialMediaBar extends Component {
  render(props) {
    return (
      <div className={this.props.hiddenBar}>
        <div className="w-80 h-10 rounded-lg border-2 border-blueReact shadow-md shadow-blueReact scale-animation container">
        ...
        <h1 className="text-center scale-animation mt-24 text-md font-mono font-semibold text-md tracking-tight">
